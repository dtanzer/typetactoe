...
const board3 = playX('TOP', 'RIGHT')(board2, isFreeField);
console.log(board3.render());
console.log(board3.status());

const board4 = playO('TOP', 'CENTER')(board3, isFreeField);
console.log(board4.render());
console.log(board4.status());

const board5 = playX('BOTTOM', 'CENTER')(board4, isFreeField);
console.log(board5.render());
console.log(board5.status());

const board6 = playO('MIDDLE', 'LEFT')(board5, isFreeField);
console.log(board6.render());
console.log(board6.status());

const board7 = playX('MIDDLE', 'RIGHT')(board6, isFreeField);
...
const board9 = playX('BOTTOM', 'LEFT')(board8, isFreeField);
